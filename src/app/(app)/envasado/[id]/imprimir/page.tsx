          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b text-left text-muted-foreground">
                ...
                <th className="py-0.5 pr-2 font-normal">Unidades</th>
                <th className="py-0.5 pr-2 font-normal">Desperdicio</th>
                <th className="py-0.5 font-normal">Consumo total</th>
              </tr>
            </thead>
            <tbody>
              {insumosUso.map((i) => (
                <tr key={i.id} className="border-b border-dashed">
                  ...
                  <td className="py-0.5 pr-2">{totalUnidades}</td>
                  <td className="py-0.5 pr-2">{i.desperdicio ?? 0}</td>
                  <td className="py-0.5">{totalUnidades + (i.desperdicio ?? 0)}</td>
                </tr>
              ))}
            </tbody>
          </table>
