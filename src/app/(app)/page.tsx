...
const CARDS: {
  ...
  },
  {
    ...
    icon: Beaker,
    roles: ["jefe_planta", "supervisor", "calidad", "asistente_adm"],
  },
  {
    href: "/envasado",
  ...
  },
  {
    href: "/equipos",
    title: "Equipos",
    description: "Ocupación en vivo, línea de tiempo y pronóstico de terminación.",
    icon: Factory,
    roles: ["jefe_planta", "supervisor", "asistente_adm"],
  },
  {
  ...
  },
  {
    ...
    icon: Tags,
    roles: ["jefe_planta", "asistente_adm"],
  },
];
